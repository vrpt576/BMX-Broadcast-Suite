...
The v1.2.12 MSI installs an automatic Windows service named `BMXBroadcastSuite`. It uses the MSI's private Python runtime and WinSW 2.12.0; no console window, script launcher, or Scheduled Task is involved.
