...
BBS 1.2.5 includes a graphical Windows installer:

```text
BMX-Broadcast-Suite-Setup-v1.2.5.exe
```
...
1. Right-click `BMX-Broadcast-Suite-Setup-v1.2.5.exe` and choose **Run as administrator**.
