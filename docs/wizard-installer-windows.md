...
BBS 1.2.13 uses `BMX-Broadcast-Suite-Setup-v1.2.13.msi`, built by WiX Toolset v4. It retains the native MSI and Windows-service architecture introduced in v1.2.11.
...
```powershell
msiexec.exe /x BMX-Broadcast-Suite-Setup-v1.2.13.msi PURGEUSERDATA=1
```
