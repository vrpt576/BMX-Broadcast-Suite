...
BBS 1.2.3 can start automatically at machine boot and run without a terminal window. It also includes a desktop and system-tray controller using `logo.png`.
