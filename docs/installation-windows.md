...
Install Microsoft ODBC Driver 18 for SQL Server (64-bit), then install `BMX-Broadcast-Suite-Setup-v1.2.14.msi`. Python and all Python packages are included; setup performs no downloads.
