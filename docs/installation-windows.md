...
For the simplest installation, download and run `BMX-Broadcast-Suite-Setup-v1.2.10.exe` from the GitHub release. See the [Windows Setup Wizard](wizard-installer-windows.md). The commands below remain available for development and advanced installation.
