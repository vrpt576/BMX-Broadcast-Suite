...
Yes for official Round 1–3, Main, and Overall classifications exposed by the
RaceManager schema. BBS never infers finish order from lanes. A classification
