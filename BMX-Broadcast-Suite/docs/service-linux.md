...
BBS 1.2.1 can run as a machine-wide systemd service on Ubuntu/Linux. The connector starts during boot, does not need an open terminal, and automatically restarts after a failure.
