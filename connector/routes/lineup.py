...
<head>
  ...
  <style>
    :root { font-family: Arial, Helvetica, sans-serif; color: white; }
    * { box-sizing: border-box; }
    body { margin: 0; width: 100vw; height: 100vh; overflow: hidden; background: transparent; }
    .wrap { position: absolute; left: 4vw; bottom: 5vh; width: min(900px, 92vw); filter: drop-shadow(0 6px 12px rgba(0,0,0,.45)); }
    .header { display: flex; align-items: stretch; width: fit-content; max-width: 100%; }
    .round { background: #f3b61f; color: #101820; padding: .32em .7em; font-size: 27px; font-weight: 950; letter-spacing: .05em; text-transform: uppercase; }
    .class { background: #101820; padding: .32em .75em; font-size: 27px; font-weight: 900; text-transform: uppercase; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
    .moto { background: #f3b61f; color: #101820; padding: .32em .65em; font-size: 27px; font-weight: 950; white-space: nowrap; }
    .riders { width: min(760px, 88vw); background: rgba(16,24,32,.96); border-top: 4px solid #f3b61f; }
    .rider { display: grid; grid-template-columns: 78px 110px 1fr; align-items: center; min-height: 58px; border-bottom: 1px solid rgba(255,255,255,.18); }
    .rider:last-child { border-bottom: 0; }
    .gate { align-self: stretch; display: grid; place-items: center; background: #f3b61f; color: #101820; font-size: 32px; font-weight: 950; }
    .bike { padding: 0 .7em; color: #f3b61f; font-size: 27px; font-weight: 900; text-align: center; }
    .name { padding: .3em .8em .3em .2em; font-size: 28px; font-weight: 850; text-transform: uppercase; letter-spacing: .02em; }
    .empty { padding: 1.2em; font-size: 24px; font-weight: 700; }
    .offline { display: none; background: rgba(16,24,32,.94); color: #fff; padding: .7em 1em; font-size: 22px; font-weight: 800; width: fit-content; }
  </style>
</head>
<body>
  <section class="wrap" aria-live="polite">
    <div id="graphic">
      ...
      <div id="riders" class="riders"></div>
    </div>
