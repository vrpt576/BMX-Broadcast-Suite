...
class BBSTray:
    def __init__(self) -> None:
        ...
        self.menu = Gtk.Menu()
        self.header = self._item("BMX Broadcast Suite 1.2.6", sensitive=False)
        self.status_items = [self._item("Checking statusâ€¦", sensitive=False) for _ in range(3)]
    ...
    def _refresh(self) -> bool:
        ...
        self.header.set_label(f"BMX Broadcast Suite {status.version or '1.2.6'}")
        return True
