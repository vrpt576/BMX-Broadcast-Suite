...
$title.Text = "BMX Broadcast Suite 1.2.10"
...
"@
        ...
        [System.Windows.Forms.Application]::DoEvents()
        & $registrationScript -InstallDir $target -Version "1.2.10"

        $status.Text = "Installation complete."

        [System.Windows.Forms.MessageBox]::Show(
            "BMX Broadcast Suite 1.2.10 was installed successfully.`r`n`r`nConfigure it at http://localhost:8000/configuration",
            "Setup complete",
            "OK",
            "Information"
        ) | Out-Null
